...
public MergeSort()
{
 ...
 public MergeSort(int _tablica[]) // konstruktor klasy z argumentem tworzący tablice pomocniczą 
    {
            tab = _tablica;
...
stop = System.nanoTime();
    ...
    public void time() // metoda zapisująca czas
    {
        long czas = stop - start;
        System.out.println("czas wykonania MergeSort " + czas +" nanosekundy");
         File file = new File("Czas_MergeSort.txt");
        try {
    ...
    public void save() // metoda zapisująca tablice
    {
           ...
           File file = new File("Tablice.txt");
            ...
            try {
                    ...
                    String tekst ="tablica po posortowaniu MergeSort "+" Przestawień = " + przestawiam  + ".\r\n";
                    zapis.write(tekst);
                    String tekst1 = "";
                    for(int i=0; i<tab.length; i++)
                    {
